package project_1;
/////////////////////////////////////////////////////////////////////
public class Grid_1 extends Grid
{
   ...
   public void setLeftBorderLocation()
   {
      ...
      {
         if (y != 5) // (0, 5) on the map has no wall
         {
   ...
   {
      super.setEntity(leftBridge, 0, 6);
      super.setEntity(leftBridge, 0, 4);
   }
   ...
   public boolean move(boolean wasOnGrass, GameEntity player)
   {
      ...
      switch (ui.move())
      {
         ...
         case "a": //Move Player Left
            ...
            {
               canMove = false;
               player.setCurrentGrid(2);
               player.setLocation(14, 5);
            }
